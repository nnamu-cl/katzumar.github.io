...
ambLight = new THREE.AmbientLight(0x0000ff, 0.02)
scene.add(ambLight)
...
for (let i = 0; i < 800; i++){
   ...
   var loader = document.getElementById("loading")
    ...
    var mobile_loader = document.getElementById("mobile-loader")
    $("#mobile-loader").fadeOut("slow")
    mobile_loader.style.display = 'none'
